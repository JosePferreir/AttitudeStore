...
<div class="container">
    ...
    <div class="d-flex justify-content-between">
        <div>
            <a href="/attitudeStore/compra/principal" class="btn btn-primary">Voltar</a>
        </div>
        <div>
            <c:if test="${carrinho.roupas.size() > 0}">
            <a href="/attitudeStore/compra/finalizarCompra" class="btn btn-primary">Finalizar Compra</a>
            </c:if>
        </div>
    </div>
