...
<div class="container mt-3">
                ...
                <c:forEach var="c" items="${usuarios}">
                    <c:if test="${c.permissao.nome == 'CLIENTE'}">
                        <tr>
                            ...
                            <td>${c.email}</td>
                            <td>
                                <a href="clientes?op=ExcluirUsuario&&id=${c.id}">
                                    <i class="fas fa-trash-alt" style="color: #FF0000;"></i>
                                </a>
                                <a href="/attitudeStore/usuario/editar/${c.id}">
    ...
    <a class="btn mt-3" style="background-color: #7B9B9B;" href="/attitudeStore/admin/home">Voltar</a>
</div>
